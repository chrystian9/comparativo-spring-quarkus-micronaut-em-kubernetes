...
public class UncompletedTaskUseCaseImplTest {
    private final TaskFactory taskFactory = new TaskFactory();
    private final TaskOutputPort taskOutputPortMock = mock(TaskOutputPort.class);

    private final UncompletedTaskUseCaseImpl uncompletedTaskUseCase = new UncompletedTaskUseCaseImpl(taskOutputPortMock, new TaskMapper());
    ...
    void executeCallCompleteTaskByIdWhenTaskIsFound() throws DomainException, CoreException {
        ...
        expectedTask = expectedTask.uncomplete();
        ...
        // when
        TaskDTO taskDTO = uncompletedTaskUseCase.uncompletedTaskById(task.getId());
    ...
    void executeCallCompletedTaskByIdMethodWhenTaskIsNotFound() {
        ...
        // given
        assertThatThrownBy(() -> uncompletedTaskUseCase.uncompletedTaskById(VALID_ID))
